...
from numpy.lib.function_base import _select_dispatcher, append
import pandas as pd
import numpy as np
...
class gui( api , Frame ):
    ...
    def save(self):
        ...
        bt = tkinter.Button(newWindow, text="save", width= 10 , bd='5' ,  command=go , bg = 'gray' , fg = 'black').place(x = 140 , y = 50)
    ...
    def create_widgets(self):
        ...
        self.coin_label = Label(self , text = 'get_coin' , bg = 'khaki2').grid(row = 0 , column=0 , sticky='NSEW' , pady = 10 , padx = 10)
        self.coin_entry = Entry(self , width = 20 )
        self.coin_entry.grid(row = 0 , column=1 , padx=10 , pady = 10)
        self.time_label = Label(self , bg = 'khaki2' , text  = 'Time').grid(row = 1, column=0 , sticky='NSEW' , pady = 10 , padx=10)
        self.time_entry = Entry(self , width=20)
        self.time_entry.grid(row = 1 , column=1 , padx = 10 , pady = 10 )
        self.period_label = Label(self , bg = 'khaki2' , text = 'perod_<days>').grid(row = 3 , column = 0 , sticky='NSEW' , pady = 10 , padx=10)
        self.period_entry = Entry(self , width= 20)
        self.period_entry.grid(row = 3 , column=1) 
        self.coin_label = tkinter.Button(self , bd = "5" ,  text = 'get_coin' , fg = 'khaki1' , bg = 'gray26'  , command= self.get_coins).grid(row = 4 ,  column=0  , sticky='NSEW' , pady = 15 , padx = 10)
        self.coin_label = tkinter.Button(self , bd = "5" , text = 'account_info', fg = 'khaki1' , bg = 'gray26'  , command= self.show_account).grid(row = 4 ,  column=1 , sticky='NSEW' , pady = 15 , padx = 10)
        self.coin_label = tkinter.Button(self ,bd = "5" ,  text = 'plot_coin' , fg = 'khaki1' , bg = 'gray26'  , command= self.plot_coin).grid(row = 5 ,  column=0 , sticky='NSEW' , pady = 15 , padx = 10)

        self.save_but = tkinter.Button(self, bd = "5" , text="saved_file", width = 10 ,  bg = 'gray29' ,  command=self.save , fg = 'khaki2').place(x = 180 , y =300)
        self.quit_but = tkinter.Button(self, bd = "5" ,  text = 'Quit' , width=10 , bg = 'gray29' , command = self.quit  ,fg = 'khaki2').place(x = 180 , y = 350)
